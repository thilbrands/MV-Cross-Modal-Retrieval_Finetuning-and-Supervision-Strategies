...
- Phase 2: segments_raw.csv bauen (identisch zu data/downloader.py)
- Phase 3: Video-Partial-Download (angepasst)
- Phase 4: segments_balanced.csv bauen (identisch zu data/downloader.py)
"""
...
def build_subset_csv(
    ...
    # IDENTISCH zu data/downloader.py (CSV-Erstellung)
