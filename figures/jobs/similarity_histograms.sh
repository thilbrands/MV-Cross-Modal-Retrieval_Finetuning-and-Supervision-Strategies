...
#SBATCH --output=/work2/ra39oxet-DatasetAudioSetSubset/logs/similarity_histograms_%j.out
#SBATCH --error=/work2/ra39oxet-DatasetAudioSetSubset/logs/similarity_histograms_%j.err
...
echo "Starte figures/plot_similarity_histograms.py …"

export PYTHONUNBUFFERED=1
python3 "$REPO_ROOT/figures/plot_similarity_histograms.py"
exit $?
