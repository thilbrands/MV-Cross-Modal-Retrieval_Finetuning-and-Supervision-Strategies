...
#   bash generalization_experiment/run_e4_interpolation.sh
#   sbatch generalization_experiment/run_e4_interpolation.sh
#   DATASET_RUN_NAME=2026-03-13_18-12-31_audioset sbatch generalization_experiment/run_e4_interpolation.sh
#
set -e
...
export TRAINING_RUN_DIR="$WORK_ROOT/training_runs/e4_interpolation"
