...
METRICS_CSV = training_run_dir / "results_audio_encoder_pair.csv"
...
train_ds = RawAudioPairDataset("train", TRAIN_VAL_TEST_SPLIT_CSV, EMBEDDINGS_DIR, allow_labels=train_genres)
val_ds = RawAudioPairDataset("val", TRAIN_VAL_TEST_SPLIT_CSV, EMBEDDINGS_DIR, allow_labels=train_genres)
