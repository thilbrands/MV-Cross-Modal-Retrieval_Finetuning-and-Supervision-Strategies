...
#   sbatch --export=DATASET_RUN_NAME=...,HP_LR=1e-3,HP_LR_ENCODER=1e-4,HP_OUT_DIM=64,HP_TEMP=1.5,HP_HEAD_TYPE=mlp,HP_HIDDEN_DIM=512 jobs/audio_encoder_genre_training.sh
#
