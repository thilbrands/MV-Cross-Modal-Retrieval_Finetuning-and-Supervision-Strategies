"""
comparison_eval: Evaluation for comparison with related work
...
Vorgehen:
  ...
  - Ausgabe: nur die kombinierte CSV (A+B).
...
combined_csv = output_dir / "results_evaluation_for_comparison_with_related_work.csv"
...
print("")
print(f"Saved: {combined_csv}", flush=True)
