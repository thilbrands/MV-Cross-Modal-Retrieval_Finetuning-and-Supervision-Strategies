...
#SBATCH --output=/work2/ra39oxet-DatasetAudioSetSubset/logs/genre_centroid_margin_%j.out
#SBATCH --error=/work2/ra39oxet-DatasetAudioSetSubset/logs/genre_centroid_margin_%j.err
